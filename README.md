...
桌面上还有个 56×56 的纯白四芒星悬浮窗，右键就能打开 Web Chat 开始聊天，或者打开「小本本」看看 AstrBot 记住了什么。
...
- 这篇 README 和项目计划文档也是 AI 辅助写的

总的来说就是「人定方向、AI 写代码、人审结果」——一个人 30 天从零到开源。
...
```bash
# 1. 把整个 Nexus_brain/ 丢进 AstrBot 的 data/plugins/
# 2. 复制一份配置
cp config.example.yaml config.yaml

# 3. 改改 config.yaml（角色名、要不要开记忆之类的）
# 4. 在 AstrBot 面板启用 Nexus_brain 插件
# 5. 悬浮窗自己就出来了
```
